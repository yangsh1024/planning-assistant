    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/api/user/login", "/api/web-auth/requests", "/api/web-auth/requests/*/status",
                                "/api/web-auth/requests/*/exchange", "/api/web-auth/sso/exchange").permitAll()
                        .requestMatchers("/api/agent/**").hasRole("WEB")
                        .requestMatchers("/api/web-auth/requests/*/preview", "/api/web-auth/requests/*/approve", "/api/web-auth/requests/*/reject", "/api/web-auth/login-codes/resolve",
                                "/api/web-auth/miniapp-links").hasRole("MINIAPP")
